<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RandomizerTutorial.aspx.cs" Inherits="SwingsetDotNet.RandomizerTutorial" %>
...
<p class="newsItem">
	...
	int GenerateRandomNumber() { <br />
		<span style="padding-left: 25px;">Random ranGen = new Random((int)DateTime.Now.Ticks);</span><br />
